...
const mapStateToProps = ({productUpdateResponse, getImageResponse}) => {
  ...
  if (images) {
    ...
    console.log(images[1], 'aaaa');
  }

  console.log(loading, 'loaddd edit', images);
...
import {UpdateProduct,
  DownloadFirstPhoto} from '../redux/actions';
import {connect} from 'react-redux';
import {PacmanIndicator} from 'react-native-indicators';
import localData from '../localJson/universityData.json';
(width = Dimensions.get('window').width),
...
export default connect(mapStateToProps, {UpdateProduct,DownloadFirstPhoto})(EditProduct);
